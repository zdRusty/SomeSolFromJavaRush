        ...
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (stock1.containsKey("change")&&stock2.containsKey("change")
                        &&!(stock1.get("change")).equals(stock2.get("change")))
                    return (int) ((double)stock1.get("change")-(double)stock2.get("change"));
                if (stock1.containsKey("open")&&stock2.containsKey("open")
                        &&!(stock1.get("open")).equals(stock2.get("open")))
                    return (int) ((double)stock1.get("last")-(double)stock1.get("open")-(double)stock2.get("last")+(double)stock2.get("open"));
                return 0;
            }
        });
    }
