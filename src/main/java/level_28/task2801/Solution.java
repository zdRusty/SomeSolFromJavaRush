...
public class Solution {
    ...
    public static void switchTest(Enum obj) {
        String enamName = obj.getClass().getSimpleName();
        switch (enamName){
            case ("E1"):
            case ("E2"):
                System.out.println("it's "+ enamName+"."+ obj);
                break;
            default:
                System.out.println("undefined");//add your code here
        }
    }
}
